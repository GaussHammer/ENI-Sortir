...
final class Version20220927094248 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant ADD campus_id INT NOT NULL, CHANGE id_participant id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON participant');
        $this->addSql('ALTER TABLE participant DROP campus_id, CHANGE id id_participant INT AUTO_INCREMENT NOT NULL');
